...
@section('content')
    ...
    <section class="calendar--section container-lg" id="calendar">
        ...
        <img class="calendar--bg calendar--bg-1" src="{{ asset('assets/images/schedule-bg-1.png') }}" alt="" srcset="">
        <img class="calendar--bg calendar--bg-2" src="{{ asset('assets/images/schedule-bg-2.png') }}" alt="" srcset="">
        <script>
            let schedule = {
                1:[
                    {
        ...
        <div class="pricing--section">
            ...
            <div class="pricing--regular">
                <div class="pricing--regular-price">
                    ...
                    <span><span>&nbsp;</span></span>
                    <div class="price">
                        <div><span> {{ __('pricing.one_two') }} {{ __('pricing.dh') }}</span><span>/{{ __('pricing.month') }}</span></div>
                        <span><span>*</span> {{ __('pricing.three') }} {{ __('pricing.dh') }} {{ __('pricing.inscription_fees') }}</span>
                        {{-- <span>+</span>
